...
0. **D-17 ตัดสินใจแล้ว (ทางเลือก ก — สร้าง flow ยืนยันอีเมลจริง) → กำลังตรวจ Site URL/Redirect URL ใน Supabase ก่อนออกแบบ flow** → ดู `DECISIONS.md` D-17 นี่คือสิ่งเดียวที่ค้างอยู่ก่อนปิด L1 ฝั่ง FlutterFlow ได้เต็มตัว
...
1. ~~D-17 — Confirm Email เปิดอยู่จริง แต่ยังไม่เลือกทางรับมือ~~ → ✅ ตอบแล้ว 2026-08-09 เลือกทางเลือก (ก) สร้าง flow ยืนยันอีเมลจริง — ดู `DECISIONS.md` **D-17** · กำลังตรวจ Site URL/Redirect URL ก่อนออกแบบ flow · บล็อกการปิด L1 ฝั่ง FlutterFlow อยู่จนกว่าจะสร้างเสร็จ
