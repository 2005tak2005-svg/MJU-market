...
7. **[D-42] `ProductDetails` โชว์รูปสินค้าจริงแล้ว (เดิม static icon ไม่เคยผูกเลย) — รอ pete ทดสอบผ่านแอปจริง** — เช็ค: รูปขึ้นจริงสำหรับสินค้าที่มีรูป, สินค้าไม่มีรูปเห็น fallback icon ไม่ crash, field อื่น (ชื่อ/ราคา/สภาพ/หมวดหมู่/รายละเอียด/ผู้ขาย/เบอร์โทร) ยังถูกต้องเหมือนเดิม
