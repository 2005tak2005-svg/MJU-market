...
tools: Read, Glob, Grep, Edit, mcp__supabase__execute_sql, mcp__supabase__list_tables, mcp__supabase__list_migrations
model: sonnet
---

<!-- 📌 ก็อปไฟล์นี้ไปที่ .claude/agents/doc-syncer.md ก่อนใช้งาน -->
